...
/**
 * REST controller for managing {@link es.jferna57.myfinances.domain.Entry}.
 */
@RestController
@RequestMapping("/api")
public class EntryResource {
    ...
    public ResponseEntity<Entry> updateEntry(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, entry.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Entry> partialUpdateEntry(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, entry.getId()));
    }
